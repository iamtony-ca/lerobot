...
* **데이터 구축 파이프라인의 현실적 병목:** Data Quality를 결정짓는 시연자(Expert)의 숙련도와 Leader Device의 사용 편의성이 전체 파이프라인의 핵심 병목(Bottleneck)임을 체감했습니다. 향후 고도화된 AI를 위해서는 데이터 수집 및 액션 데이터 생성의 자동화/편의성 개선이 매우 중요해질 것입니다.
